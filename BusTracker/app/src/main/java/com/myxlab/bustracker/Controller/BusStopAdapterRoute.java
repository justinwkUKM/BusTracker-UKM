 ...
 */
public class BusStopAdapterRoute extends RecyclerView.Adapter<BusStopAdapterRoute.ViewHolder> {
     ...
     */
    public BusStopAdapterRoute(List<BusStop> busStopList) {
    ...
    @Override
    public BusStopAdapterRoute.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.route_item, null, false);
        RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        view.setLayoutParams(lp);
        BusStopAdapterRoute.ViewHolder viewHolder = new BusStopAdapterRoute.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(BusStopAdapterRoute.ViewHolder holder, int position) {
