...
public class NavigationActivityOri extends BaseActivity {
...
//    private ProgressBar progressbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BusStopAdapter busStopAdapter = new BusStopAdapter(UserInstance.getInstance().getBusStopList().get(busStopIndex).getBus(), UserInstance.getInstance().getBusStopList().get(busStopIndex), getApplicationContext(), navigationActivity);
