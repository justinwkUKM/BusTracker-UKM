...
import com.myxlab.bustracker.View.RouteList;
...
public class RouteAdapter extends RecyclerView.Adapter<RouteAdapter.ViewHolder> {
    ...
    private RouteList journeyActivity;
     ...
     */
    public RouteAdapter(List<Route> routeList, FragmentManager fragmentManager, RouteList journeyActivity) {
    ...
    public void onBindViewHolder(RouteAdapter.ViewHolder holder, int position) {
        ...
        holder.icon.setImageResource(R.drawable.ic_directions_journey);
