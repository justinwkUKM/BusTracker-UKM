...
$sid = $_GET['delete'];
$sql = "delete from station where S_Id = '".$sid."'";
...
<script type="text/javascript" src="../../dist/js/map_station.js"></script>
...
<!--            google_map-->
 ...
 <!--            stations table-->
    ...
    <div class="col-md-12">
     ...
     <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-station">
             <thead>         
                <tr>
                  <th style="width: 5%">Id</th>
                  <th style="width: 20%">Name</th>
                  <th style="width: 10%">Code</th>
                  <th style="width: 10%">Load Level</th>
              ...
              <tbody>
                   <?php
                  $sql = "SELECT * FROM `station` ORDER BY `S_Id` DESC";
                  $result = $con->query($sql);
             ...
             <tr>
                ...
                <td><?php 
                 ...
                 <td >
                  <a href="detail.php?did=<?php echo $readrow['S_Id']; ?>" class="btn btn-link btn-xs" role="button"><i class='glyphicon glyphicon-list-alt'></i> Details</a>
                  <a href="edit.php?edit=<?php echo $readrow['S_Id']; ?>" class="btn btn-link btn-xs" role="button"><i class='glyphicon glyphicon-edit'></i> Edit </a>
                  <a href="index.php?delete=<?php echo $readrow['S_Id']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-link btn-xs" role="button"><i class='glyphicon glyphicon-trash'></i> Delete</a>
                </td>
             </tr>
              <?php } ?>
                </tbody>
