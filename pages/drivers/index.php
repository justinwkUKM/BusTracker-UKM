...
<body>
 ...
 <!--           // breadcrumb-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="col-md-12">
                        <tr>
                            <th class="col-md-6"><h1>Drivers</h1></th>
  ...
  <!--            Drivers Table-->
          <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-driver">
             <thead>         
                <tr>
              ...
              <tbody>
                   <?php
                  $sql = "SELECT * FROM `driver_info` ORDER BY `DI_Id` DESC";
                  $result = $con->query($sql);
             ...
             <tr>
                ...
                <td >
                  <a href="detail.php?did=<?php echo $readrow['DI_Id']; ?>" class="btn btn-link btn-xs" role="button"><i class='glyphicon glyphicon-list-alt'></i> Details</a>
                  <a href="edit.php?edit=<?php echo $readrow['DI_Id']; ?>" class="btn btn-link btn-xs" role="button"><i class='glyphicon glyphicon-edit'></i> Edit </a>
                  <a href="index.php?delete=<?php echo $readrow['DI_Id']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-link btn-xs" role="button"><i class='glyphicon glyphicon-trash'></i> Delete</a>
                </td>
             </tr>
              <?php } ?>
                </tbody>
