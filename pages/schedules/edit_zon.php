...
<body>
 ...
 <!--           // breadcrumb-->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Zone</h1>
            ...
            <!--         // Edit Code-->
                  ...
                  <form action="add_zon.php" method="post" class="form-horizontal">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                  <input name="code" type="text" class="form-control" id="code" placeholder="Code" value="<?php if(isset($_GET['edit'])) echo $editrow['Z_Name']; ?>" required>
                                </div>
                            </div>
                           
                            <div class="form-group">
                                 <label for="type" class="col-sm-3 control-label">Type</label>
                                 <?php if(isset($_GET['edit'])) $ty = $editrow['Z_Type'];?>
                                  <div class="col-sm-9">
                                 <select name="type" class="form-control" id="type" required>
                                   <option value="">Please select type</option>
                                    ...
                                    $sql = "SELECT * FROM `bus_code` WHERE `BC_Type` = 'bas'";
                                      ...
                                      ?>   
                                         <option value="<?php echo $readrow['BC_Code']; ?>" <?php if(isset($_GET['edit'])) if($readrow['BC_Code']== "$ty") echo "selected"; ?>><?php echo $readrow['BC_Code']; ?></option>
                                      <?php } ?>  
                                  </select>
                                </div>
                            </div>  
